...
%BIG STEP
queryL(0, _, Dim, NumOfTests, Cert, Delta, _, Gamma, E, expr) :- 
...
queryL(1, Gas, Dim, NumOfTests, Cert, Delta, Vars, Gamma, P, prog) :- 
...
queryL(2, Gas, Dim, NumOfTests, Cert, Delta, Vars, Gamma, P, prog) :- 
...
queryL(3, _, Dim, NumOfTests, Cert, _, _, Gamma, E, expr) :- 
    write("Check has_type"), nl,
    genNRandExp(Cert, NumOfTests, Dim, T, E, Gamma),    
    updateGeneratedTest(),    
    updateSuccessfulTest(), 
...
queryL(4, _, Dim, NumOfTests, Cert, Delta, Vars, Gamma, E, expr) :- 
...
queryL(6, _, Dim, NumOfTests, Cert, Delta, Vars, Gamma, E, expr) :- 
...
% SMALL STEP
queryL(7, Gas, Dim, NumOfTests, Cert, Delta, Vars, Gamma, P, prog) :- 
...
queryL(8, Gas, Dim, NumOfTests, Cert, Delta, Vars, Gamma, P, prog) :- 
...
queryL(9, _, Dim, NumOfTests, Cert, Delta, _, Gamma, P, prog) :- 
...
queryL(10, _, Dim, NumOfTests, Cert, Delta, Vars, Gamma, P, prog) :- 
...
queryL(11, _, Dim, NumOfTests, Cert, Delta, Vars, Gamma, P, prog) :- 
...
% BIG STEP & SMALL STEP
queryL(12, Gas, Dim, NumOfTests, Cert, Delta, Vars, Gamma, P, prog) :- 
...
queryL(13, Gas, Dim, NumOfTests, Cert, Delta, Vars, Gamma, P, prog) :- 
