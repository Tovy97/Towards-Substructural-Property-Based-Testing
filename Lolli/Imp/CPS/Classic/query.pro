...
%BIG STEP
queryC(0, _, Dim, Dim2, Cert, State, _, Type, E, expr) :- 
    write("Determinismo eval --> forall e:t, eval(e, v1) -> eval(e, v2) -> v1 = v2"), nl,
    genExp(Cert, Dim, Dim2, _, E, Type),   
    updateGeneratedTest(),     
...
queryC(1, Gas, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
...
queryC(2, Gas, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
...
queryC(3, _, Dim, Dim2, Cert, _, _, Type, E, expr) :- 
    write("Check has_type"), nl,
    genExp(Cert, Dim, Dim2, T, E, Type),     
    updateGeneratedTest(),  
    updateSuccessfulTest(), 
...
queryC(4, _, Dim, Dim2, Cert, State, _, Type, E, expr) :- 
...
queryC(6, _, Dim, Dim2, Cert, State, _, Type, E, expr) :- 
...
% SMALL STEP
queryC(7, Gas, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
...
queryC(8, Gas, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
...
queryC(9, _, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
...
queryC(10, _, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
...
queryC(11, _, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
...
% BIG STEP & SMALL STEP
queryC(12, Gas, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
...
queryC(13, Gas, Dim, Dim2, Cert, State, _, Type, P, prog) :- 
